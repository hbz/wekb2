...
class AjaxJsonController {
    ...
    def getRefdata() {
        ...
        if (params.id == 'boolean') {
            ...
            List rq = RefdataValue.executeQuery('select rdv from RefdataValue as rdv where rdv.useInstead is null and rdv.owner.desc = :desc order by rdv.value asc, rdv.description asc', [desc: params.id], [max: 400, offset: 0]);
