...
<g:if test="${d.id}">
    ...
    <semui:tabsItemContent tab="platforms" activeTab="${params.activeTab}">
        <g:link class="display-inline" controller="search" action="inlineSearch"
                params="[s_controllerName: controllerName, s_actionName: actionName, objectUUID: params.id, max: params.max, offset: params.offset, sort: params.sort, order: params.order, qbe: 'g:platforms', refOID: d.getOID(), inline: true, qp_curgroup: d.getOID(), hide: ['qp_curgroup'], activeTab: 'platforms']"
                id="">Platforms published</g:link>
    </semui:tabsItemContent>

    <semui:tabsItemContent tab="currentTitles" activeTab="${params.activeTab}">
        <g:link class="display-inline" controller="search" action="inlineSearch"
                params="[s_controllerName: controllerName, s_actionName: actionName, objectUUID: params.id, max: params.max, offset: params.offset, sort: params.sort, order: params.order, qbe: 'g:tipps', refOID: d.getOID(), inline: true, qp_curgroup: d.getOID(), hide: ['qp_curgroup'], qp_status: RefdataValue.class.name + ':' + RDStore.KBC_STATUS_CURRENT.id, activeTab: 'currentTitles']"
    ...
    <semui:tabsItemContent tab="retiredTipps" activeTab="${params.activeTab}">
        ...
        <div class="content">
            ...
            <g:link class="display-inline" controller="search" action="inlineSearch"
                    params="[s_controllerName: controllerName, s_actionName: actionName, objectUUID: params.id, max: params.max, offset: params.offset, sort: params.sort, order: params.order, qbe: 'g:tipps', refOID: d.getOID(), inline: true, qp_curgroup: d.getOID(), hide: ['qp_curgroup'], qp_status: RefdataValue.class.name + ':' + RDStore.KBC_STATUS_RETIRED.id, activeTab: 'retiredTipps']"
    ...
    <semui:tabsItemContent tab="deletedTipps" activeTab="${params.activeTab}">
        ...
        <div class="content">
            ...
            <g:link class="display-inline" controller="search" action="inlineSearch"
                    params="[s_controllerName: controllerName, s_actionName: actionName, objectUUID: params.id, max: params.max, offset: params.offset, sort: params.sort, order: params.order, qbe: 'g:tipps', refOID: d.getOID(), inline: true, qp_curgroup: d.getOID(), hide: ['qp_curgroup'], qp_status: RefdataValue.class.name + ':' + RDStore.KBC_STATUS_DELETED.id, activeTab: 'deletedTipps']"
                    id="">Packages on this Source</g:link>
    ...
    <semui:tabsItemContent tab="packages" defaultTab="packages" activeTab="${params.activeTab}">
        <g:link class="display-inline" controller="search" action="inlineSearch"
                params="[s_controllerName: controllerName, s_actionName: actionName, objectUUID: params.id, max: params.max, offset: params.offset, sort: params.sort, order: params.order, qbe: 'g:packages', refOID: d.getOID(), inline: true, qp_curgroup: d.getOID(), hide: ['qp_curgroup'], activeTab: 'packages']"
                id="">Packages on this Platform</g:link>
    </semui:tabsItemContent>

    <semui:tabsItemContent tab="providers" activeTab="${params.activeTab}">
        <g:link class="display-inline" controller="search" action="inlineSearch"
                params="[s_controllerName: controllerName, s_actionName: actionName, objectUUID: params.id, max: params.max, offset: params.offset, sort: params.sort, order: params.order, qbe: 'g:orgs', refOID: d.getOID(), inline: true, qp_curgroup: d.getOID(), hide: ['qp_curgroup'], activeTab: 'platforms']"
