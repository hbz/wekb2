...
<h1 class="ui header">Packages without Titles (${pkgs.size()})</h1>


<div class="container">

    <div class="ui segment">
        <g:form controller="admin" action="findPackagesWithoutTitles" class="ui form">
            <div class="field">
            ...
            <div class="ui right floated buttons">
                ...
                <g:link class="ui button" action="findPackagesWithoutTitles">Reset</g:link>
            </div>
